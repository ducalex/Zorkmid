...
#define ZORK_DIR {"ADDON", "taunts", "ZASSETS1/GLOBAL", "ZASSETS1/CASTLE", "ZASSETS1/GRIFFQST", \
...
//TITLE
#define TITLE "Z-Engine: Zork Nemesis [build: "__DATE__ \
              " "__TIME__                               \
              "]"
#define GAME_TITLE "Zork: Nemesis"

// Default files if Zork.dir not found
#define ZORK_DIR {"Addon", "Addon/subpatch.zfs", "ZNEMMX", "ZNEMSCR", "ZNEMSCR/GSCR.ZFS", \
